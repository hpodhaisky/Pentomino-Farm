...
# https://www.redblobgames.com/grids/hexagons/#coordinates-offset (odd r starting with (1, 1))
...
function solvePolyhex(area = Pair(16, 16))
    """
    Setup
    """
    ...
    # tetrahexes (https://en.wikipedia.org/wiki/Polyhex_(mathematics))
